...
//   kamus mini
  ...
  const dataKamus = {
    benda: [
      { kata: "Bola", arti: "Ball" },
      { kata: "Meja", arti: "Table" },
      { kata: "Kursi", arti: "Chair" },
      { kata: "Pintu", arti: "Door" },
      { kata: "mmm", arti: "ngok" },
      { kata: "nenne", arti: "Tabbbe" },
      { kata: "Kursi", arti: "Chair" },
      { kata: "Pintu", arti: "Door" },
      { kata: "Televisi", arti: "Television" }
    ],
    kegiatan: [
      { kata: "Makan", arti: "Eat" },
      { kata: "Tidur", arti: "Sleep" },
      { kata: "Menulis", arti: "Write" },
      { kata: "Membaca", arti: "Read" },
      { kata: "Berjalan", arti: "Walk" }
    ],
    aktivitas: [
      { kata: "Belajar", arti: "Study" },
      { kata: "Olahraga", arti: "Exercise" },
      { kata: "Berenang", arti: "Swim" },
      { kata: "Memasak", arti: "Cook" },
      { kata: "Bernyanyi", arti: "Sing" }
    ],
    angka: [
      { kata: "Belajar", arti: "Study" },
      { kata: "Olahraga", arti: "Exercise" },
